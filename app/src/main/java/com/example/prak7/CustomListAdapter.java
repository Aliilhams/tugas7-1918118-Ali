...
public class CustomListAdapter extends BaseAdapter {
    ...
    private List<com.example.prak7.Mahasiswa> Mahasiswa;
    public CustomListAdapter(Activity activity, List<com.example.prak7.Mahasiswa> Mahasiswa) {
    ...
    public View getView(int position, View convertView, ViewGroup
        ...
        com.example.prak7.Mahasiswa m = Mahasiswa.get(position);
